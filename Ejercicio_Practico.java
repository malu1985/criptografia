package com.mycompany.ejercicio_practico;
...
public class Ejercicio_Practico {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("INGRESE UNA PALARA");
        String frase = sn.next();
        
        String texto = codificar(letras, frase);
        System.out.println("Texto codifcado: " + texto);
        
        texto = descodificar(letras, texto);
        System.out.println("Texto Descodifcado: " + texto);
     }
